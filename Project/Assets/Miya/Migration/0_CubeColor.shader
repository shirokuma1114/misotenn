Shader "Custom/0_CubeColor"
{
	Properties{
		...
		_GradRotate_T("Gradient Rotation (Top)", Range(0, 1)) = 0.0
		[Space(20)]
		...
		_GradRotate_R("Gradient Rotation (Right)", Range(0, 1)) = 0.0
		[Space(20)]
		...
		_GradRotate_F("Gradient Rotation (Front)", Range(0, 1)) = 0.0
		[Space(20)]
		...
		_GradRotate_L("Gradient Rotation (Left)", Range(0, 1)) = 0.0
		[Space(20)]
		...
		_GradRotate_B("Gradient Rotation (Back)", Range(0, 1)) = 0.0
		[Space(20)]
		...
		_GradRotate_D("Gradient Rotation (Bottom)", Range(0, 1)) = 0.0
		[Space(15)]
